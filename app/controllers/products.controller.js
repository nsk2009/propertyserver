...
exports.findAll = async (req, res) => {
  ...
  Table.paginate(condition, { collation: { locale: "en" }, populate: [{ path: "supplier", select: ["suppliername"] }, { path: "createdBy", select: ["firstname", "lastname"] }, { path: "category", select: "name" }, { path: "modifiedBy", select: ["firstname", "lastname"] }, ], offset, limit, sort: sortObject })
    .then((data) => {
      res.send({
